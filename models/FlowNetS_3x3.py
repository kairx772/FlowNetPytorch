...
class FlowNetS(nn.Module):
    ...
    def __init__(self,batchNorm=True):
        ...
        self.conv1   = conv(self.batchNorm,   6,   64, stride=2) # 7x7 origin
        self.conv1_1 = conv(self.batchNorm,  64,   64)
        self.conv1_2 = conv(self.batchNorm,  64,   64)
        self.conv2   = conv(self.batchNorm,  64,  128, stride=2) # 5x5 origin
        self.conv2_1 = conv(self.batchNorm, 128,  128)
        self.conv3   = conv(self.batchNorm, 128,  256, stride=2) # 5x5 origin
        self.conv3_0 = conv(self.batchNorm, 256,  256)
