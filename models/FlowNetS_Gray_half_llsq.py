...
class FlowNetSGrayHalfLLSQ(nn.Module):
    ...
    def __init__(self,batchNorm=True, bias=True, bitW=32, bitA=32, cut_ratio=2):
        ...
        k_up = 4
        self.upsampled_flow6_to_5 = ConvTrans2d_Q(2, 2, k_up, 2, 1, bias=False, bit=bitW)
        self.upsampled_flow5_to_4 = ConvTrans2d_Q(2, 2, k_up, 2, 1, bias=False, bit=bitW)
        self.upsampled_flow4_to_3 = ConvTrans2d_Q(2, 2, k_up, 2, 1, bias=False, bit=bitW)
        self.upsampled_flow3_to_2 = ConvTrans2d_Q(2, 2, k_up, 2, 1, bias=False, bit=bitW)
...
def fnsghllsq_bn(data=None, bitW=32, bitA=32, cut_ratio=2):
    """FlowNetS model architecture from the
    "Learning Optical Flow with Convolutional Networks" paper (https://arxiv.org/abs/1504.06852)
