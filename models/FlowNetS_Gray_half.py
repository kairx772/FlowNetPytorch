...
__all__ = [
    'flownetsgrayhalf', 'flownetsgrayhalf_bn'
]
...
def flownetsgrayhalf(data=None, args=None):
    ...
    """
    model = FlowNetSGray(batchNorm=False, bias=args.conv_no_bias, cut_ratio=args.cut_ratio)
    if data is not None:
